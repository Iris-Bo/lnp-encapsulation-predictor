...
def load_and_split_data(filepath="data/processed/df_final_all_features.csv", test_size=0.2, random_state=126):
    """
...
def load_data(filepath="data/processed/df_final_all_features.csv"):
    """
    Loads the processed LNP dataset and separates features and target.
    """
    df = pd.read_csv(filepath)
...
def get_feature_names(filepath="data/processed/df_final_all_features.csv"):
