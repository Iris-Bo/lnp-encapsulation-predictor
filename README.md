...
An end-to-end machine learning system to predict lipid nanoparticle (LNP) encapsulation efficiency from formulation parameters.
A Random Forest Regressor was tuned and trained on carefully selected 43-feature dataset and completed with an automated API and containerized deployment.
The model was trained using formulation data from the [LNP Atlas](https://lnp-atlas.kisti.re.kr/).
...
3. **View the Dashboard:**
  Open [http://127.0.0.1:5000](http://127.0.0.1:5000) in your browser to explore the model registry, metric comparisons, and artifact logs.
4. **Run the Notebooks:**
